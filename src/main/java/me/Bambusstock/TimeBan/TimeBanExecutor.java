...
public class TimeBanExecutor implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        ...
        if (plugin.getController().getBans().isEmpty()) {
            if (sender instanceof Player) {
                ((Player) sender).sendMessage(ChatColor.RED + "No bans found!");
            } else {
    ...
    class FormatHelper {
         ...
         *
         * @param String[] Input
         * @param start Start element (will be included in the output, so choose
         * the element with start delimiter)
        ...
        /**
         * Check how many values could be jumped over if there would be used
        ...
        /**
         * Check for an parameter like -a inside a given string. Attention: Just
         * works with single parameters like "-ra" where "r" and "a" are
         * separate parameters.
         *
        ...
        /**
         * Check for an parameter like -a inside a given array. Attention: Just
         * works with single parameters like "-ra" where "r" and "a" are
         * separate parameters.
         *
        ...
        public boolean containsParameter(ArrayList<String> input, String search) {
            ...
            while (it.hasNext()) {
                if (this.containsParameter(it.next(), search)) {
                    return true;
                }
            }
            return false;
